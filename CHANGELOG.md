 ...
 * client/template: When rendering a task template, environment variables from the client are no longer included by default. [[GH-6055](https://github.com/hashicorp/nomad/issues/6055)]
